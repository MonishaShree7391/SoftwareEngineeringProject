...
def extract_text_from_pdf(pdf_path):
    ...
    """
    try:
        print('inside extract_text_from_pdf:pdf_path: ',pdf_path)
        doc = fitz.open(pdf_path)
        extracted_text = ""

        for page in doc:
            print('inside extract_text_from_pdf:extracted_text must be empty here: ', extracted_text)
            extracted_text += page.get_text("text") + "\n\n"
            print('inside extract_text_from_pdf:extracted_text must be present: ', extracted_text)
        doc.close()
